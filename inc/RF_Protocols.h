...
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(Quigg)[], static uint8_t, SI_SEG_CODE) = {  LOW(1), HIGH(0) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(Quigg)[], static uint8_t, SI_SEG_CODE) = {  LOW(0), HIGH(1) };
#endif
